...
export async function GET(request: NextRequest) {
  try {
    ...
    const serialized = {
      ...
      is_verified: investor.isVerified,
      ...
      withdrawal_requests: investor.withdrawalRequests.map(w => ({
        ...
        request_reason: w.requestReason || null,
        investor_notes: w.investorNotes || null,
        admin_notes: w.adminNotes || null,
        rejection_reason: w.rejectionReason || null,
        momo_number: w.momoNumber || null,
        momo_name: w.momoName || null,
        momo_provider: w.momoProvider || null,
        admin_receipt_url: w.adminReceiptUrl || null,
        investor_confirmed_at: w.investorConfirmedAt?.toISOString() || null,
        investor_feedback: w.investorFeedback || null,
