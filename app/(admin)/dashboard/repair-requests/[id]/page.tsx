...
export const metadata: Metadata = {
  title: "Repair Request Details | Dashboard",
  description: "View and manage repair request",
};
...
export default async function RepairRequestDetailPage({ params }: PageProps) {
  ...
  // Get technicians and apprentices for assignment
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href="/dashboard/repair-requests">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">
                    {repair.technician.employeeId}
                  </div>
                </div>
                {repair.apprentice && (
                  <div>
                    <div className="text-sm text-muted-foreground">Apprentice</div>
